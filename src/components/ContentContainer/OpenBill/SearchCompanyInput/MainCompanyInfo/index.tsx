...
class MainCompanyInfo extends React.Component<Props> {
  ...
  renderNotIpInfo = () => {
    const {
      companyResponse: { name, full_name, inn, ogrn },
      collapced,
    } = this.props;
    return (
      <>
        ...
        <Col span={20}>
          <div
            style={
              collapced ? { opacity: 0, height: 0, display: "none" } : null
            }
          >
          ...
          <div style={collapced ? styleCss.mainDescr : null}>
            ...
            <CopyToClipboard
              ...
              title="Скопировать"
              text={inn}
              onCopy={() => message.success(`${inn} - скопировано!`, 1)}
            >
              <label
                style={{
            ...
            <CopyToClipboard
              ...
              title="Скопировать"
              text={ogrn}
              onCopy={() => message.success(`${ogrn} - скопировано!`, 1)}
            >
              <label
    ...
    if (error)
      return (
        <div style={{ textAlign: "center" }}>
          {
            'Ошибка в работе компонента "Открытие счета -> Информация о компании", пожалуйста перезагрузите страницу'
          }
        </div>
      );
    return (
            ...
            <Col span={3} style={{ textAlign: "center", minHeight: "1rem" }}>
              ...
              >
                <CopyToClipboard
                  ...
                  onCopy={() =>
                    message.success(`Поисковой запрос - скопирован!`)
                  }
                >
                  <Button
