...
const CroinformDrawer = props => {
  ...
  const styledIdentifyRes = (identifyInfo && identifyInfo.html !== null) ? identifyInfo.html : ""
      ...
      >
        <Tabs >
          { (
              ...
              (fsspInfo && fsspInfo.length) || stopLists
            ) ? renderList() : null 
          }
